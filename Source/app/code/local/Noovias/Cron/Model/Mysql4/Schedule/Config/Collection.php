    ...
    extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    {
        $aJobCodeHR = strtolower(Mage::helper('noovias_cron')->__($a->getJobCode()));
        $bJobCodeHR = strtolower(Mage::helper('noovias_cron')->__($b->getJobCode()));

        if($aJobCodeHR == $bJobCodeHR){
            return 0;
        }
        return($aJobCodeHR < $bJobCodeHR) ? -1 : 1;
    }
